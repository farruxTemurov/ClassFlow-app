...
<%@ page import="com.zumba.bean.Students, com.zumba.bean.Batches, com.zumba.service.BatchesService, java.util.List" %>
...
<body>
    ...
    <form action="StudentsController" method="get">
        ...
        <label>Name:</label>
        <input type="text" name="searchName" required><br><br>
        <label>Email:</label>
        <input type="email" name="searchEmail" required><br><br>
    ...
    <% Students student = (Students) request.getAttribute("student");
       if (student != null) { %>
        ...
        <p>Telephone: <%= student.getTelephone() %></p>
        <p>Email: <%= student.getEmail() %></p>
        <p>Batch: <%= student.getBatchType() != null ? student.getBatchType() + " " + student.getBatchTime() : "Not Assigned" %></p>
    <% } %>
